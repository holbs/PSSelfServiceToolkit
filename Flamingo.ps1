...
$WPFRunNetworkTests.Add_Click({
    ...
    Start-NetworkTest -Command "ping $(If ($env:USERDNSDOMAIN) {$env:USERDNSDOMAIN} Else {$env:USERDOMAIN})"
    Start-NetworkTest -Command "tracert $(If ($env:USERDNSDOMAIN) {$env:USERDNSDOMAIN} Else {$env:USERDOMAIN})"
